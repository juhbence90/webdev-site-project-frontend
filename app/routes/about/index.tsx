...
const AboutPage = () => {
  return (
    <div className="max-w-5xl mx-aouto px-6 py-16 bg-gray-900">
      {/* Intro */}
      <div className="flex flex-col md:flew-row items-center gap-10 mb-12">
        <img
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          I aim to make development accesible, friendly, and something you look
          forward to each day.
        </p>
      </div>
      {/* Tech Stack */}
